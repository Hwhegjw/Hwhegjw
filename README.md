...
local Window = Library.CreateLib("Build A Boat V.5 + V6 OP Made By Hwhegjw1", "BloodTheme")
...
Tab1Section:NewButton("Cloud", "ok", function()
...
Tab1Section:NewButton("Goal", "ok", function()
...
Tab1Section:NewButton("Ramp", "ok", function()
...
Tab1Section:NewButton("Find Glue", "ok", function()
...
Tab1Section:NewButton("Dragon", "ok", function()
...
Tab1Section:NewButton("Mystery Block", "ok", function()
...
Tab1Section:NewButton("Soccer", "ok", function()
...
Tab1Section:NewButton("Thin ice", "ok", function()
...
Tab1Section:NewButton("Off Quest", "ques", function()
...
Tab1Section:NewButton("Easter Egg (Easter Boss fight)", "Loads in the gingerbread Fight (you need to be leader for this to work", function()
